...
import '../../views/widgets/video_player_item.dart';
import 'comment_screens.dart';
...
class VideoScreen extends StatelessWidget {
  ...
  return PageView.builder(
    itemCount: videoController.videos.length, // Use `videos` instead of `videoList`
    controller: PageController(initialPage: 0, viewportFraction: 1),
    scrollDirection: Axis.vertical,
    itemBuilder: (context, index) {
      final data = videoController.videos[index]; // Use `videos` instead of `videoList`
      return Stack(
        children: [
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    ...
                    // Right-side controls (profile, likes, comments, etc.)
                    Container(
                      width: 100,
